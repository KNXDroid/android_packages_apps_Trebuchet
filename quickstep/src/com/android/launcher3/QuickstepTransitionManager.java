...
public class QuickstepTransitionManager implements OnDeviceProfileChangeListener {
    ...
    static {
        APP_LAUNCH_DURATION = getDuration(440);
        ...
        RECENTS_LAUNCH_DURATION = getDuration(316);
        LAUNCHER_RESUME_START_DELAY = getDuration(90);
        CLOSING_TRANSITION_DURATION_MS = getDuration(150);
        SPLIT_LAUNCH_DURATION = getDuration(320);
        SPLIT_DIVIDER_ANIM_DURATION = getDuration(100);
        CONTENT_ALPHA_DURATION = getDuration(153);
